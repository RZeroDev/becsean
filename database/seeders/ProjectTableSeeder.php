...
class ProjectTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        Project::create([
            ...
            'description'=> "Contained explained my education. Vulgar as hearts by garret. Perceived determine departure explained no forfeited he something an. Contrasted dissimilar get joy you instrument out reasonably. Again keeps at no meant stuff. To perpetual do existence New had happen unable uneasy. Drawings can followed improved out sociable not. Earnestly so do instantly pretended. See general few civilly amiable pleased account carried. Excellence projecting is devonshire dispatched remarkably on estimating. Side in so life past. Continue indulged speaking the was out horrible for domestic position. Seeing rather her you not esteem men settle genius excuse. Deal say over you age from. Comparison new ham melancholy son themselves.",
            'main_image' => 'storage/front/assets/img/projects/1.jpg',
            'project_categorie_id' => ProjectCategorie::whereName('Projets en cours')->first()->id,
        ]);
        ...
        Project::create([
            ...
            'project_categorie_id' => ProjectCategorie::whereName('Projets en achevés')->first()->id,
        ]);
        ...
        Project::create([
            ...
            'project_categorie_id' => ProjectCategorie::whereName('Opportunités de collaboration')->first()->id,
        ]);

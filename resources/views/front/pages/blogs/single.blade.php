                ...
                <div class="row">
                    <div class="blog-content col-xl-8 col-lg-7 col-md-12 pr-35 pr-md-15 pl-md-15 pr-xs-15 pl-xs-15">
                        ...
                        <div class="blog-style-two item">
                            <div class="thumb">
                                <a href="blog-single-with-sidebar.html"><img src="{{ asset(FrontHelper::getEnvFolder() . 'storage/front/assets/img/banner/15.jpg') }}" alt="Thumb"></a>
                                ...
                                <div class="comments-title">
                                    ...
                                    <div class="comments-list">
                                        <div class="comment-item">
                                            <div class="avatar">
                                                <img src="{{ asset(FrontHelper::getEnvFolder() . 'storage/front/assets/img/farmers/3.jpg') }}" alt="Author">
                                            </div>
                                            <div class="content">
                                                <div class="title">
                                        ...
                                        <div class="comment-item reply">
                                            <div class="avatar">
                                                <img src="{{ asset(FrontHelper::getEnvFolder() . 'storage/front/assets/img/farmers/2.jpg') }}" alt="Author">
                                            </div>
                                            <div class="content">
                                                <div class="title">

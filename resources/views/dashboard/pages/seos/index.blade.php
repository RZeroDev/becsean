    ...
    <div class="container-fluid relative px-3">
        <div class="layout-specing">
            ...
            <div class="md:flex justify-between items-center">
                <div>
                    <h5 class="text-lg font-semibold">Reférencement SEO</h5>

                    <ul class="tracking-[0.5px] inline-block mt-2">
                        {{ Breadcrumbs::render('seos.index') }}
                    </ul>
                </div>
            </div>
                    ...
                    <table class="w-full text-start">
                        <thead class="text-base">
                            <tr>
                                ...
                                <th class="text-start p-4 min-w-[128px]">Page</th>
                                <th class="text-start p-4 min-w-[192px]">Mot clés</th>
                            ...
                            @forelse ($seos as $index=>$seo)
                                <tr>
                                    ...
                                    <td class="text-center border-t border-gray-100 dark:border-gray-800 p-4">
                                        <span class="text-slate-400">{{ $seo->page }}</span>
                                    </td>
                                    <td class="text-center border-t border-gray-100 dark:border-gray-800 p-4">
                                        <span class="text-slate-400">{!! $seo->keywords ?? '-' !!}</span>
                                    </td>
                                    <td class="text-center border-t border-gray-100 dark:border-gray-800 p-4">
                                        <span class="text-slate-400">{!! $seo->description ?? '-' !!}</span>
                                    </td>
                                    <td class="text-end border-t border-gray-100 dark:border-gray-800 p-4">
                                        <div class="flex items-center space-x-4">
                                            <a href="{{ route('seos.show', $seo) }}"
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="text-center border-t border-gray-100 dark:border-gray-800 p-4">
                                        <span aria-colspan="5" class="text-slate-400">Aucun seo enregistré</span>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>

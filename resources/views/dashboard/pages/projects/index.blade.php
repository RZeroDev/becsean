    ...
    <div class="container-fluid relative px-3">
        <div class="layout-specing">
            ...
            <div class="md:flex justify-between items-center">
                <div>
                    <h5 class="text-lg font-semibold">Projets</h5>
            ...
            <div class="grid grid-cols-1 mt-6">
                <div class="flex items-center justify-between mb-4">
                    <!-- <h2 class="text-lg font-semibold text-gray-800 dark:text-gray-300">Liste des projects</h2> -->
                        ...
                        <tbody>
                            @forelse ($projects as $index=>$project)
                                <tr>
                                    ...
                                    <td class="text-start border-t border-gray-100 dark:border-gray-800 p-4">
                                        <a href="#" class="hover:text-indigo-600">
                                            <div class="flex items-center">
                                                <img src="{{ asset(FrontHelper::getEnvFolder() . $project->main_image) }}"
                                    ...
                                    <td class=" border-t border-gray-100 dark:border-gray-800 p-4">
                                        <span class="text-slate-400">{{ $project->projectcategorie->name }}</span>
                                    </td>
                                    @hasanyrole('super-admin|admin|dev')
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="text-center border-t border-gray-100 dark:border-gray-800 p-4">
                                        <span class="text-slate-400">Aucun project enregistré</span>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>

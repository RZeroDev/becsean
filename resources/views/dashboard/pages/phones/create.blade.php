...
@section('title', 'Ajout de numéro de téléphone')
@section('content')
<div class="container-fluid relative px-3">
    <div class="layout-specing">
        <!-- Start Content -->
        <div class="md:flex justify-between items-center">
            <h5 class="text-lg font-semibold">Ajout de numéro de téléphone</h5>
        ...
        <div class="grid lg:grid-cols-12 md:grid-cols-2 grid-cols-1 mt-6 gap-6">
            <div class="lg:col-span-6">
                <div class="p-6 rounded-md shadow dark:shadow-gray-700 bg-white dark:bg-slate-900">
                    ...
                    <form method="post" class="myForm" action="{{ route('phones.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="grid lg:grid-cols-12 grid-cols-1 mt-6 gap-5">
                            <div class="lg:col-span-12">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" placeholder="Numéro de téléphone" name="name" required="" value="{{ old('name') }}">
                                @error('name')

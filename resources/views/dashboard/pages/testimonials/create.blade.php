...
@section('title', 'Ajout d\'un témoignage')
@section('content')
    <div class="container-fluid relative px-3">
        <div class="layout-specing">
            ...
            <div class="md:flex justify-between items-center">
                <div>
                    <h5 class="text-lg font-semibold">Ajout d'un témoignage</h5>
            ...
            <div class="grid md:grid-cols-12 grid-cols-1 mt-6 gap-6">
                <div class="lg:col-span-12 md:col-span-6">
                    ...
                    <div class="p-6 rounded-md shadow dark:shadow-gray-700 bg-white dark:bg-slate-900 mt-6">
                        ...
                        <form class="mt-6 myForm" action="{{ route('testimonials.store') }}" method="POST"
                                    ...
                                    <div class="text-start">
                                        ...
                                        <div class="form-icon relative mt-2">
                                            <textarea name="description" id="description"
                                                ...
                                                placeholder="Description du témoignage :">{{ old('description') }}</textarea>
                                        </div>
                                        @error('contenu')
                                            <span class="text-danger">
                                                <strong>{{ $message }}</strong>

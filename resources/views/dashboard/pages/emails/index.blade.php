    ...
    <div class="container-fluid relative px-3">
        <div class="layout-specing">
            ...
            <div class="md:flex justify-between items-center">
                <div>
                    <h5 class="text-lg font-semibold">Emails</h5>
            ...
            <div class="grid grid-cols-1 mt-6">
                <div class="flex items-center justify-between mb-4">
                    <!-- <h2 class="text-lg font-semibold text-gray-800 dark:text-gray-300">Liste des emails</h2> -->
                    ...
                    <table class="w-full text-start">
                        <thead class="text-base">
                            <tr>
                                ...
                                <th class="text-start p-4 min-w-[192px]">Adresse</th>
                                @hasanyrole('super-admin|admin|dev')
                            ...
                            @forelse ($emails as $index=>$email)
                                <tr>
                                    ...
                                    <td class=" border-t border-gray-100 dark:border-gray-800 p-4">
                                        <span class="text-slate-400">{{ $email->name }}</span>
                                    </td>
                                    @hasanyrole('super-admin|admin|dev')
                            ...
                            @empty
                                <tr>
                                    <td class="text-center border-t border-gray-100 dark:border-gray-800 p-4">
                                        <span class="text-slate-400">Aucun mail enregistré</span>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>

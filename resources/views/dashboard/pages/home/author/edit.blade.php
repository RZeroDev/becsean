    ...
    <div class="container-fluid relative px-3">
        <div class="layout-specing">
            ...
            <div class="md:flex justify-between items-center">
                <div>
                    <h5 class="text-lg font-semibold">Contenu de l'auteur</h5>

                    <ul class="tracking-[0.5px] inline-block sm:mt-0 mt-3">
                        {{ Breadcrumbs::render('authorSections.edit', $authorSection->id) }}
                    </ul>
                </div>
            </div>
            <br>
            ...
            <div class="grid md:grid-cols-12 grid-cols-1 mt-6 gap-6">
                <div class="lg:col-span-12 md:col-span-6">
                    <div class="p-6 rounded-md shadow dark:shadow-gray-700 bg-white dark:bg-slate-900 mt-6">
                        ...
                        <form id="" class="myForm" action="{{ route('authorSections.update', $authorSection) }}" method="POST"
                                    ...
                                    <div class="text-start">
                                        ...
                                        <div class="form-icon relative mt -2">
                                            ...
                                            <input name="title" id="title" type="text" 
                                                value="{{ old('title', $authorSection->title) }}"
                                    ...
                                    <div class="text-start">
                                        ...
                                        <div class="form-icon relative mt -2">
                                            ...
                                            <input name="actionText" id="actionText" type="text" 
                                                value="{{ old('actionText', $authorSection->actionText) }}"
                                    ...
                                    <div class="text-start">
                                        ...
                                        <div class="form-icon relative mt -2">
                                            ...
                                            <input name="actionUrl" id="actionUrl" type="text" 
                                                value="{{ old('actionUrl', $authorSection->actionUrl) }}"
                                    ...
                                    <div class="text-start">
                                        ...
                                        <div class="form-icon relative mt-2">
                                            <textarea name="description" id="key" type="text" rows="5"
                                                class="form-control @error('description') is-invalid @enderror " placeholder="Mots-clés de la page">{{ old('description1', $authorSection->description) }}</textarea>
                                        </div>
                                        @error('description')
                                            <span class="text-danger">
                                                <strong>{{ $message }}</strong>
